...
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::chi() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::fv2
(
    const volScalarField& chi,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::Stilda
(
    const volScalarField& chi,
    const volScalarField& fv1
)   const
...
template<class BasicTurbulenceModel>
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::fw
(
...
template<class BasicTurbulenceModel>
void ML_RNG<BasicTurbulenceModel>::correctNut
(
    const volScalarField& fv1
)
{
...
template<class BasicTurbulenceModel>
ML_RNG<BasicTurbulenceModel>::ML_RNG
(
...
template<class BasicTurbulenceModel>
bool ML_RNG<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::DnuTildaEff() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> ML_RNG<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void ML_RNG<BasicTurbulenceModel>::correct()
{
  if (!this->turbulence_)
  {
      return;
  ...
  int num_inputs = 4;
  int num_outputs = 1;  
  double mean_array [num_inputs+num_outputs] = {3.974928417108912271e+01,-1.200867154544176252e+00,4.808239254796427969e-02,-4.134784774507140048e-02,2.070326388086911502e-03};
  double std_array [num_inputs+num_outputs] = {5.450719336407781057e+00,4.413283008198113144e+00,4.545372374067887383e-02,3.161890801185181510e-01,2.052573006821842381e-03};
...
template<class BasicTurbulenceModel>
void ML_RNG<BasicTurbulenceModel>::run_ml_graph(double* mean_array, double* std_array, int num_inputs, int num_outputs)
{

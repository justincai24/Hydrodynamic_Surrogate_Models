...
//0~2 6
//(
//(4.079686917592934492e+01 -1.208243514188240608e+00 -3.261139731191171065e-01 5.640163886112639635e-02 1.303085616937946556e+00 1.613694987496413135e-03)
//(6.916749517394584323e+00 5.413467829647387930e+00 5.565129236052048789e-01 4.110704482615899769e-02 5.275577461920756273e-01 2.269512471019279141e-03)
//);1~
//  RectangularMatrix<doubleScalar>mean_std_vals(IFstream("means")());
  RectangularMatrix<doubleScalar> mean_std_vals(2, 6);
  mean_std_vals(0,0) = 40.796869;
  mean_std_vals(0,1) = -1.20824;
  mean_std_vals(0,2) = -0.326114;
  mean_std_vals(0,3) = 0.0564016;
  mean_std_vals(0,4) = 1.3030856;
  mean_std_vals(0,5) = 0.001613695;
  mean_std_vals(1,0) = 6.9167495;
  mean_std_vals(1,1) = 5.4134678;
  mean_std_vals(1,2) = 0.5565129;
  mean_std_vals(1,3) = 0.04110704;
  mean_std_vals(1,4) = 0.52755775;
  mean_std_vals(1,5) = 0.002268512;
  int num_inputs = 5;
  int num_outputs = 1;
